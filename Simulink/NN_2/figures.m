...
subplot(4,1,3)
hold on
plot(tauNN.Time, v.Data(1,:), 'r-', 'LineWidth', 1.5) 
plot(tauNN.Time, v.Data(2,:), 'g-', 'LineWidth', 1.5) 
plot(tauNN.Time, v.Data(3,:), 'b-', 'LineWidth', 1.5)
hold off
legend({'$v_1$', '$v_2$', '$v_3$'}, 'Interpreter', 'latex', ...
       'FontSize', 12, 'Location', 'best')
ylabel('Torque (Nm)', 'FontSize', 12)
title('Robustifying Term Contribution', 'FontSize', 14)
grid on
